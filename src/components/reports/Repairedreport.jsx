...
const Repairedreport = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 p-6">
      ...
      {/* HEADER */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800"> Repaired Report</h1>
        <p className="text-gray-500 text-sm">Track all Repaired devices</p>
      </div>
              ...
              {data.length > 0 ? (
                data.map((item, i) => (
                  ...
                  >
                    ...
                    <td className="p-2 border">
                      {item.visualIssues?.length ? item.visualIssues.join(", ") : "-"}
                    </td>
                    <td className="p-2 border">
